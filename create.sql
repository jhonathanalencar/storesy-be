...
insert into lak.category (category_id, name) values ('4a7a41d1-879e-43ba-9e1b-6eab6e1b446b', 'headphones');
insert into lak.category (category_id, name) values ('d61ccf6d-b8f7-48a9-ba0e-a15b0050bfae', 'technology');
